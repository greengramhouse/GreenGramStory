...
const highlights: Highlight[] = [
  {
    ...
    description:
      "Crafting practical and responsive web applications using Next.js, React, Node.js, HTML, CSS, and Tailwind.",
  },
  {
    title: "Automation & AI",
    description:
      "Streamlining manual workflows with Google Apps Script and integrating AI solutions to boost productivity.",
  },
  {
    title: "Freelance Availability",
    description:
      "Available for freelance projects. Bringing an 'Admin Who Codes' perspective to build real-world, user-friendly tools.",
  },
];
...
const socialLinks: SocialLink[] = [
  {
    label: "Facebook",
    handle: "@gukkghu.ja",
    href: "https://www.facebook.com/gukkghu.ja",
    icon: Facebook,
  },
  // {
  //   label: "LinkedIn",
  ...
  {
    label: "GitHub",
    handle: "greengramhouse",
    href: "https://github.com/greengramhouse",
    icon: Github,
  },
];
...
export function GlassmorphismPortfolioBlock({
  className,
  badgeText = "Portfolio Insight",
  title = "Waroonporn Rattanabhutchai",
  description = "I am available for freelance projects, focusing on building practical and responsive web applications. My tech stack includes Next.js, React, Node.js, and Tailwind CSS. I also love leveraging Google Apps Script and AI technologies to build automated workflows that make life easier.",
  ctaText = "เข้าชมบล็อกของฉัน",
  ctaLink = "/blog",
}: {
  className?: string;
  badgeText?: string;
  ...
  return (
    <section
      className={cn(
        "relative flex min-h-screen items-center overflow-hidden px-6 py-12 lg:py-20",
        className
      )}
    >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    ...
                    <div className="relative h-32 w-32 overflow-hidden rounded-full border border-border/40 shadow-[0_25px_60px_rgba(15,23,42,0.3)] dark:shadow-[0_25px_60px_rgba(0,0,0,0.6)]">
                      <Image
                        src="https://res.cloudinary.com/dqyxo3d2h/image/upload/f_auto,q_auto,w_512,c_fill,g_face/v1773672861/20260206_073337_1_fag4wu.jpg"
                        alt="Casper Lightman"
                        fill
                  ...
                  >
                    Freelance Web Developer. Building smart applications with React, Next.js
